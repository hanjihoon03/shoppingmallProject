...
public class QUploadFile extends EntityPathBase<UploadFile> {
    ...
    private static final long serialVersionUID = -534914272L;
    ...
    public final shoppingmall.project.domain.item.QItem item;
    ...
    public QUploadFile(Class<? extends UploadFile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new shoppingmall.project.domain.item.QItem(forProperty("item")) : null;
    }
